...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapPage = __webpack_require__(168);
	__webpack_require__(172);

	var ClickableMap = function (_React$Component) {
	  _inherits(ClickableMap, _React$Component);

	  function ClickableMap() {
	    _classCallCheck(this, ClickableMap);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ClickableMap).apply(this, arguments));
	  }

	  _createClass(ClickableMap, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(MapPage, null);
	    }
	  }]);
	...
	ReactDOM.render(React.createElement(ClickableMap, null), document.getElementById('react-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WorldMap = __webpack_require__(169);
	//require imgs
	var randomizeImg = __webpack_require__(170);
	var randomizeImgSelected = __webpack_require__(171);
	...
	var MapPage = function (_React$Component) {
	  ...
	  function MapPage() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MapPage).call(this));

	    _this.questionId = Math.random().toString().slice(7);
	    _this.randomizeImg = randomizeImg;
	    _this.continueBtnClass = "map-btn-disabled";
	    _this.state = { randomizeSelected: false, mapSelected: false };
	    return _this;
	  }
	  ...
	  _createClass(MapPage, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      window.addEventListener('onMapSelect', function () {
	        _this2.toggleSelectedState('mapOn');
	      });
	      window.addEventListener('onMapUnselect', function () {
	        _this2.toggleSelectedState('mapOff');
	      });
	    }
	  }, {
	    ...
	    value: function toggleSelectedState(mapState) {
	      this.setState(function () {
	        var newState = { randomizeSelected: false, mapSelected: false };
	        if (mapState === 'mapOn') {
	    ...
	    key: 'enableButton',
	    value: function enableButton(enable) {
	      if (enable) {
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement('img', { className: 'map-random', src: this.randomizeImg, onClick: this.onRandomizeClick.bind(this) }),
	        React.createElement(
	          'div',
	          { className: this.continueBtnClass + ' map-continue-btn' },
	          React.createElement(
	            'a',
	            { href: '#' },
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WorldMap = function (_React$Component) {
	  ...
	  function WorldMap(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WorldMap).call(this, props));

	    _this.state = {
	      mapSelected: false,
	      na: "map-unselected-na",
	      sa: "map-unselected-sa",
	      af: "map-unselected-af",
	      eu: "map-unselected-eu",
	      as: "map-unselected-as",
	      oc: "map-unselected-oc"
	    };
	    return _this;
	  }
	  ...
	  _createClass(WorldMap, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      window.addEventListener('onRandomizeClick', function () {
	        if (_this2.state.mapSelected) {
	          _this2.setAreaStates('randomize');
	        }
	      });
	    }
	  }, {
	    key: "onMapClick",
	    value: function onMapClick(area) {
	      this.setAreaStates(area);
	    }
	  }, {
	    key: "setAreaStates",
	    value: function setAreaStates(area) {
	      this.setState(function () {
	        var newState = {
	          mapSelected: true,
	          na: "map-unselected-na",
	        ...
	        if (area === 'randomize') {
	          ...
	          newState[area] = this.toggleState(area);
	        }
	        return newState;
	      });
	    }
	    ...
	    key: "toggleState",
	    value: function toggleState(area) {
	      var unselected = "map-unselected-" + area;
	      var newState = '';
	      if (this.state[area] === unselected) {
	        newState = "map-selected-" + area;
	        window.dispatchEvent(this.mapSelectEvent);
	      } else {
	        newState = "map-unselected-" + area;
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          "svg",
	          { className: "map-img", xmlns: "http://www.w3.org/2000/svg", width: "672", height: "315", viewBox: "0 0 672 315", id: "svg5249" },
	          React.createElement(
	            "defs",
	            { id: "defs5257" },
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "cc328a3e67f77a05ebeecf35cd88deb9.svg";

/***/ },
/* 171 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "886a328718e4c908b4cd3d2317f8702b.svg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".map-selected-na, .map-selected-sa, .map-selected-af, .map-selected-eu, .map-selected-as, .map-selected-oc {\n  fill: #0DC2ED; }\n  .map-selected-na:hover, .map-selected-sa:hover, .map-selected-af:hover, .map-selected-eu:hover, .map-selected-as:hover, .map-selected-oc:hover {\n    cursor: pointer; }\n\n.map-unselected-na, .map-unselected-sa, .map-unselected-af, .map-unselected-eu, .map-unselected-as, .map-unselected-oc {\n  fill: #699EAA; }\n  .map-unselected-na:hover, .map-unselected-sa:hover, .map-unselected-af:hover, .map-unselected-eu:hover, .map-unselected-as:hover, .map-unselected-oc:hover {\n    cursor: pointer; }\n\n.map-random {\n  height: 40px;\n  display: inline;\n  margin: 0px 10px; }\n  .map-random:hover {\n    cursor: pointer; }\n\n.map-continue-btn {\n  display: inline-block;\n  margin-left: 300px; }\n\n.map-btn-disabled, .map-btn-proceed {\n  border-radius: 33px;\n  padding: 10px;\n  text-align: center;\n  font-size: 18px; }\n  .map-btn-disabled a, .map-btn-proceed a {\n    color: white;\n    text-decoration: none; }\n\n.map-btn-disabled {\n  background-color: #868686;\n  pointer-events: none; }\n\n.map-btn-proceed {\n  background-color: #3AD493; }\n  .map-btn-proceed:hover {\n    background-color: #80E3BA; }\n", ""]);
